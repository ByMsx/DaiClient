...
public slots:
    ...
    void log_value_data(const QPair<quint32, quint32> &range, QVector<quint32>* not_found, QVector<ValuePackItem>* data_out);
    void log_event_data(const QPair<quint32, quint32> &range, QVector<quint32>* not_found, QVector<EventPackItem>* data_out);
private:

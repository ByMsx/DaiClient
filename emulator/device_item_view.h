...
class Device_Item_View : public QWidget
{
    Q_OBJECT
private:
    QGroupBox *device_group_box_ = nullptr;
    QTreeView *units_tree_view_ = nullptr;
    Units_Table_Model *units_table_model_ = nullptr;
...
public:
    ...
    void add_device(Dai::Device *dev) noexcept;
